...
function displayGreetings() {
  ...
  if (waketime == hours) {
    document.getElementById("food_image").src= "url('./Curtains.png')";
    document.getElementById("food_msg").innerHTML = "Let's have some breakfast";
  }

  if (lunchtime == hours) {
    document.getElementById("food_image").src= "url('./lunch.png')";
    document.getElementById("food_msg").innerHTML = "Let's have lunch";
  }
  if (naptime == hours) {
    document.getElementById("food_image").src= "url('./sleepS.png')";
